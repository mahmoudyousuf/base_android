...
class ConfirmForgetPasswordRepository @Inject constructor(
    ...
    suspend fun confirmForgetPassword(props: JsonObject):  Response<BaseResponse<BaseResponse.EmptyData>> =
        api.confirmForgetPassword(
            props
        )
